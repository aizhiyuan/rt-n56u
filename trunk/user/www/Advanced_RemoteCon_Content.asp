...
function applyRule(){
	showLoading();
	document.form.sid_list.value = "IPConnection;"
                            ...
                            <div class="round_bottom">
                                <div class="row-fluid">
									...
									<table width="100%" cellpadding="4" cellspacing="0" class="table table-list" id="P2PVSList_Block">
                                        <tr>
                                            <th colspan="7" style="background-color: #E3E3E3;">路由拓扑配置</th>
											<input type="hidden" name="p2p_num_x_0" value="<% nvram_get_x("P2PConnection", "p2p_num_x"); %>" readonly="1" />
                                        </tr>
                                        <tr>
                                            <td width="20%">现场名称</td>
                                            <td width="25%">远程值守IP地址</td>
                                            <td width="25%">远程内网IP地址</td>
                                            <td width="25%">远程内网掩码</td>
                                            <td width="5%">&nbsp;</td>
                                        </tr>
                                        <tr>
                                            <td>
                                    ...
                                    <table class="table">
                                        <tr>
                                            <td style="border: 0 none;"><center><input name="button" type="button" class="btn btn-primary" style="width: 219px" onclick="applyP2PRule();" value="<#CTL_apply#>"/></center></td>
                                        </tr>
                                    </table>
                                </div>
                            </div>
