...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--prefix=/opt/rt-n56u/trunk/stage --cross-prefix=/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc- --enable-cross-compile --arch=mips --target-os=linux --cc='/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc-gcc -mips32r2 -march=mips32r2' --as='/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc-as -mips32r2 -march=mips32r2' --enable-static --disable-shared --enable-small --enable-pthreads --enable-gpl --enable-zlib --disable-doc --disable-debug --disable-avdevice --disable-network --disable-swscale --disable-swscale-alpha --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-hwaccels --disable-dxva2 --disable-indevs --disable-outdevs --disable-devices --disable-filters --disable-encoders --disable-muxers --disable-decoders --disable-demuxers --disable-parsers --disable-postproc --disable-protocols --disable-bsfs --disable-everything --enable-protocol=file --enable-parser=aac --enable-parser=ac3 --enable-parser=mpegaudio --enable-demuxer=aac --enable-demuxer=ac3 --enable-demuxer=asf --enable-demuxer=avi --enable-demuxer=dts --enable-demuxer=eac3 --enable-demuxer=flac --enable-demuxer=flv --enable-demuxer=h264 --enable-demuxer=m4v --enable-demuxer=matroska --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=ogg --enable-demuxer=wav
...
SRC_PATH="/opt/rt-n56u/trunk/libs/libav/ffmpeg-0.6.x"
SRC_PATH_BARE=/opt/rt-n56u/trunk/libs/libav/ffmpeg-0.6.x
BUILD_ROOT="/opt/rt-n56u/trunk/libs/libav/ffmpeg-0.6.x"
ARCH=mips
CC=/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc-gcc -mips32r2 -march=mips32r2
AS=/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc-as -mips32r2 -march=mips32r2
LD=/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc-gcc -mips32r2 -march=mips32r2
DEPCC=/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc-gcc -mips32r2 -march=mips32r2
YASM=yasm
YASMDEP=yasm
...
CFLAGS=-Os -fomit-frame-pointer -pipe  -DEMBED -I/opt/rt-n56u/trunk/stage/include -Dlinux -D__linux__ -Dunix -Wall -Wno-trigraphs -Wno-strict-aliasing -Wno-format-security   -Wno-pointer-sign -ffunction-sections -fdata-sections -D_LARGEFILE64_SOURCE -D_LFS64_LARGEFILE -D_LARGEFILE64_SOURCE -D_LFS64_LARGEFILE   -std=c99 -fomit-frame-pointer -fPIC -pthread -Wdeclaration-after-statement -Wall -Wno-switch -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wno-pointer-sign -Wcast-qual -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=implicit -Werror=missing-prototypes -Werror=return-type
ASFLAGS=   -fPIC
CC_O=-o $@
DLLTOOL=
LDFLAGS= -L/opt/rt-n56u/trunk/stage/lib -Wl,--gc-sections -Wl,--warn-common -Wl,--as-needed -Wl,-rpath-link,$(BUILD_ROOT)/libpostproc -Wl,-rpath-link,$(BUILD_ROOT)/libswscale -Wl,-rpath-link,$(BUILD_ROOT)/libavfilter -Wl,-rpath-link,$(BUILD_ROOT)/libavdevice -Wl,-rpath-link,$(BUILD_ROOT)/libavformat -Wl,-rpath-link,$(BUILD_ROOT)/libavcodec -Wl,-rpath-link,$(BUILD_ROOT)/libavutil -Wl,-Bsymbolic
