...
#define FFMPEG_CONFIGURATION "--prefix=/opt/rt-n56u/trunk/stage --cross-prefix=/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc- --enable-cross-compile --arch=mips --target-os=linux --cc='/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc-gcc -mips32r2 -march=mips32r2' --as='/opt/rt-n56u/toolchain-mipsel/toolchain-3.4.x/bin/mipsel-linux-uclibc-as -mips32r2 -march=mips32r2' --enable-static --disable-shared --enable-small --enable-pthreads --enable-gpl --enable-zlib --disable-doc --disable-debug --disable-avdevice --disable-network --disable-swscale --disable-swscale-alpha --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-ffserver --disable-hwaccels --disable-dxva2 --disable-indevs --disable-outdevs --disable-devices --disable-filters --disable-encoders --disable-muxers --disable-decoders --disable-demuxers --disable-parsers --disable-postproc --disable-protocols --disable-bsfs --disable-everything --enable-protocol=file --enable-parser=aac --enable-parser=ac3 --enable-parser=mpegaudio --enable-demuxer=aac --enable-demuxer=ac3 --enable-demuxer=asf --enable-demuxer=avi --enable-demuxer=dts --enable-demuxer=eac3 --enable-demuxer=flac --enable-demuxer=flv --enable-demuxer=h264 --enable-demuxer=m4v --enable-demuxer=matroska --enable-demuxer=mov --enable-demuxer=mp3 --enable-demuxer=mpegps --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-demuxer=ogg --enable-demuxer=wav"
#define FFMPEG_LICENSE "GPL version 2 or later"
#define FFMPEG_DATADIR "/opt/rt-n56u/trunk/stage/share/ffmpeg"
#define CC_TYPE "gcc"
